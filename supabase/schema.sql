...
-- SCANS TABLE (stores every disease scan)
...
(
  ...
  array['Plant certified disease-resistant seeds','Rotate with legumes every season','Ensure proper spacing (75cm between rows)','Scout fields weekly during vegetative stage']
),
(
  ...
  array['Stake plants for air circulation','Avoid overhead watering — use drip irrigation','Apply copper-based fungicides preventively','Remove infected leaves immediately']
),
(
  'Potatoes', '🥔', 'Root crop',
...
-- ── SEED SAMPLE SHOPS ──
insert into shops (name, address, phone, lat, lon, products, is_sponsored) values
('GreenGrow Agro-Vet', 'Main Market Road, Nakuru', '+254712345678', -0.2833, 36.0667, array['Fungicides','Pesticides','Seeds','Fertilizers'], true),
('FarmCare Supplies', 'Kenyatta Avenue, Nakuru', '+254723456789', -0.2850, 36.0700, array['Herbicides','Fungicides','Equipment'], false),
('AgriPlus Kenya', 'Industrial Area, Nakuru', '+254734567890', -0.2900, 36.0750, array['Seeds','Soil Tests','Fertilizers','Pesticides'], false),
('Farmers Choice', 'Bondeni Estate, Nakuru', '+254745678901', -0.2780, 36.0600, array['All inputs','Consultancy'], false);
...
-- Public read for crops and shops
